...
namespace Verduleria
{
    public partial class frmmenu : Form
    {
        ...
        public frmmenu(string nivelAcceso, string ciUsuario)
        {
            InitializeComponent();
            ...
            else if (this.rolUsuario == "Cajero")
            {
                ...
                btnUsuario.Enabled = false; // Bloqueamos el acceso al módulo de usuarios para el cajero
            ...
            else if (this.rolUsuario == "Repositor")
            {
                ...
                btnUsuario.Enabled = false; // Bloqueamos el acceso al módulo de usuarios para el repositor
        ...
        {
            Usuario frm = new Usuario(this.rolUsuario);
            frm.ShowDialog();
        }

        private void btncompra_Click(object sender, EventArgs e)
        {
            Compra frm = new Compra(this.rolUsuario);
            frm.ShowDialog();
        }

        private void btnventa_Click(object sender, EventArgs e)
        {
            Venta frm = new Venta(this.rolUsuario, this.ciUsuario);
            frm.ShowDialog();
        }
    }
}
